...
export default function SpaceDetails() {
  ...
  useEffect(() => {
    async function loadBookings() {
      try {
        const result = await apiFetch(`/spaces/${id}/bookings`);
  ...
  const pricePerHour = Number(displayedSpace?.price_per_hour ?? displayedSpace?.pricePerHour ?? 0);
